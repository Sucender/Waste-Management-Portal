    ...
    <div  class=" col-3-md ml-1 mr-2 " >
				<div id= class="card"  style="width: 18rem;">
					...
					<div id="ram" class="card-body">
						...
						<button type="submit" class="btn btn-primary view_data" id="<?php echo $row['id']; ?>"disabled> Read more..</button></div>
              ...
              <div  class=" col-3-md ml-1 mr-2 " >
				<div id= class="card"  style="width: 18rem;">
					...
					<div id="ram" class="card-body">
						...
						<button type="submit" class="btn btn-primary view_data" id="<?php echo $row['id']; ?>"> Read more..</button>
					</div>
				</div>
			</div>
...
<script type="text/javascript">
	...
	window.location.href="kannimoolaganapathy.php";
