...
<div class="container-fluid" id="Details">
	<div id="refer" class="row">
		...
		while ($row=mysqli_fetch_assoc($result)) {
            ...
            <div  class=" col-3-md ml-1 mr-2 " >
				<div id="car" class="card"  style="width: 18rem;">
					...
					<div id="ram" class="card-body">
						...
						<button class="btn btn-primary"  name="vp" type="submit" id="do" style="float:right;color:white">Do Service</button>
					</div>
				</div>
			</div>
  ...
  $("#do").click(function(){
	 // $(".btn btn-primary view_data").remove()
	 
    $("#do").remove();
	count++;
	//document.write(count);
	//$('.card').css("filter","blur(2px)");
	//$('.card').css("filter",",");
